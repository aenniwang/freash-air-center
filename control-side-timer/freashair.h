...
#define CMD_SET_POWER 0x82
#define CMD_GET_POWER 0x83
#define CMD_SET_POWER_PERIOD_ON 0x84
#define CMD_GET_POWER_PERIOD_ON 0x85
#define CMD_SET_POWER_PERIOD_OFF 0x86
#define CMD_GET_POWER_PERIOD_OFF 0x87
#define CMD_GET_POWER_TIMER 0x88
